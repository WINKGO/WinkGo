 ...
 *   - macOS:   ~/Library/Logs/WinkGo/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\WinkGo\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/WinkGo/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
...
const BACKEND_PREFIX = '[winkgo_core]';
