...
type FileTypeIconProps = {
  ...
  expanded?: boolean;
  /** Render size in CSS pixels. Defaults to the compact workspace-tree size. */
  size?: number;
};
 ...
 */
const FileTypeIcon: React.FC<FileTypeIconProps> = ({ node, expanded, size = DEFAULT_ICON_SIZE }) => {
  ...
  return (
    ...
    >
      <Icon icon={`${ICON_PREFIX}:${name}`} width={size} height={size} />
    </span>
  );
};
