...
const MemoizedSortableConversationRow = React.memo(SortableConversationRow);
MemoizedSortableConversationRow.displayName = 'SortableConversationRow';

export default MemoizedSortableConversationRow;
