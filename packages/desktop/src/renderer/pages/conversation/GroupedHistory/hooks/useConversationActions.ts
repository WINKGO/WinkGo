...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via WinkGoModal in the GroupedHistory component.
   * Uses project's design system: WinkGoModal component with danger-styled action button.
   */
