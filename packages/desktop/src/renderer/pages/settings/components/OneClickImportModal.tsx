...
import WinkGoSteps from '@/renderer/components/base/WinkGoSteps';
  ...
  return (
    ...
    >
      <div className='flex min-h-0 flex-col'>
        ...
        <div className='mb-6'>
          <WinkGoSteps current={currentStep} size='small'>
            <WinkGoSteps.Step
            ...
            />
            <WinkGoSteps.Step title={t('settings.mcpStepImportSuccess')} />
          </WinkGoSteps>
        </div>
