...
import { resolveAgentAvatar, type AgentLogoMap } from '@/renderer/utils/model/agentLogo';
import {
...
const AgentCard: React.FC<AgentCardProps> = (props) => {
  ...
  const { agent, logos, boundAssistants, onTestConnection, onConfigure, isTesting } = props;
