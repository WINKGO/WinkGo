...
const WinkGoAgentChat = React.lazy(
  () => import('@/renderer/pages/conversation/platforms/winkgo_agent/WinkGoAgentChat')
);
...
/** WinkGoAgent sub-component manages model selection state without adding a ChatLayout wrapper */
const WinkGoAgentTeamChat: React.FC<{
  ...
  const modelSelection = useWinkGoAgentModelSelection({ initialModel: conversation.model, onSelectModel });
    ...
    switch (conversation.type) {
      ...
      case 'winkgo_agent':
        return (
          <WinkGoAgentTeamChat
            key={conversation.id}
            conversation={conversation as WinkGoAgentConversation}
            emptySlot={emptySlot}
