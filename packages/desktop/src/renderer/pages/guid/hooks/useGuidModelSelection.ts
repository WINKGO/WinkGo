...
type ProviderAgentKey = 'winkgo_agent';
 ...
 * @param agentKey - current provider-based agent (currently only 'winkgo_agent')
 */
export const useGuidModelSelection = (agentKey: ProviderAgentKey = 'winkgo_agent'): GuidModelSelectionResult => {
