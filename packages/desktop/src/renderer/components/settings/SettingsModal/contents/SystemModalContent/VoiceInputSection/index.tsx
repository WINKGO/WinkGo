        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <WinkGoSelect value={source} onChange={handleSourceChange}>
                <WinkGoSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</WinkGoSelect.Option>
                <WinkGoSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</WinkGoSelect.Option>
                <WinkGoSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</WinkGoSelect.Option>
              </WinkGoSelect>
            </Form.Item>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <WinkGoSelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <WinkGoSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <WinkGoSelect.Option key={option.value || 'auto'} value={option.value}>
