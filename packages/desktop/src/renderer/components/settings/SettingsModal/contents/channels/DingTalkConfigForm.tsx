...
const DINGTALK_DEV_DOCS_URL = 'https://github.com/WINKGO/wink-go/wiki/DingTalk-Bot-Setup-Guide';
...
const DingTalkConfigForm: React.FC<DingTalkConfigFormProps> = ({ pluginStatus, modelSelection, onStatusChange }) => {
  ...
  const showModelSelector = isWinkGoAgentAssistant(selectedAssistant);
