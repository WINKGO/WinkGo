                ...
                {imageGenerationModelList.length > 0 ? (
                  ...
                  >
                    {imageGenerationModelList.map(({ models, ...platform }) => (
                      <WinkGoSelect.OptGroup label={platform.name} key={platform.id}>
                        {models.map((modelName) => (
                          <WinkGoSelect.Option key={platform.id + modelName} value={platform.id + '|' + modelName}>
                            {modelName}
                          </WinkGoSelect.Option>
                        ))}
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/WINKGO/wink-go/wiki/WinkGo-Image-Generation-Tool-Model-Configuration-Guide'
                            target='_blank'
