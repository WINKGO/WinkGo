...
const WinkGoSearchInput = forwardRef<HTMLInputElement, WinkGoSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
WinkGoSearchInput.displayName = 'WinkGoSearchInput';

export default WinkGoSearchInput;
