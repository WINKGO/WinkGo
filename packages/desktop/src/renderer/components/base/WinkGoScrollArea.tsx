 ...
 * <WinkGoScrollArea className="h-400px">
 *   <div>Content...</div>
 * </WinkGoScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <WinkGoScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </WinkGoScrollArea>
 *
 * // 双向滚动 / Both directions
 * <WinkGoScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </WinkGoScrollArea>
 * ```
 */
interface WinkGoScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const WinkGoScrollArea: React.FC<WinkGoScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
WinkGoScrollArea.displayName = 'WinkGoScrollArea';

export default WinkGoScrollArea;
