...
type WinkGoSelectSize = NativeSelectSize | 'middle';

export interface WinkGoSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: WinkGoSelectSize;
}

/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .winkgo-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .winkgo-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <WinkGoSelect placeholder="请选择" style={{ width: 200 }}>
 *   <WinkGoSelect.Option value="1">选项1</WinkGoSelect.Option>
 *   <WinkGoSelect.Option value="2">选项2</WinkGoSelect.Option>
 * </WinkGoSelect>
 *
 * // 多选 / Multiple selection
 * <WinkGoSelect mode="multiple" placeholder="请选择多个">
 *   <WinkGoSelect.Option value="1">选项1</WinkGoSelect.Option>
 *   <WinkGoSelect.Option value="2">选项2</WinkGoSelect.Option>
 * </WinkGoSelect>
 *
 * // 分组 / Grouped options
 * <WinkGoSelect placeholder="请选择">
 *   <WinkGoSelect.OptGroup label="分组1">
 *     <WinkGoSelect.Option value="1">选项1</WinkGoSelect.Option>
 *   </WinkGoSelect.OptGroup>
 *   <WinkGoSelect.OptGroup label="分组2">
 *     <WinkGoSelect.Option value="2">选项2</WinkGoSelect.Option>
 *   </WinkGoSelect.OptGroup>
 * </WinkGoSelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.winkgo-select)
 */
const mapSizeToNative = (size?: WinkGoSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type WinkGoSelectComponent = React.ForwardRefExoticComponent<WinkGoSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, WinkGoSelectProps>(
...
const WinkGoSelect = InternalSelect as WinkGoSelectComponent;

WinkGoSelect.displayName = 'WinkGoSelect';

// 导出子组件 / Export sub-components
WinkGoSelect.Option = Select.Option;
WinkGoSelect.OptGroup = Select.OptGroup;

export default WinkGoSelect;
