...
// Mirror of winkgo-api-types/src/assistant.rs.
...
export function isWinkGoAgentAssistant(assistant?: Pick<Assistant, 'agent'> | null): boolean {
  return assistant?.agent?.type === 'winkgo_agent';
}
