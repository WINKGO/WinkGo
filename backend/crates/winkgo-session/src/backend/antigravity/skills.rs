...
//! does invoke a skill (verified), and WINK GO provisions those skills itself
...
/// Where agy looks for workspace skills, and where WINK GO provisions them.
...
mod tests {
    ...
    fn reads_name_and_description_from_frontmatter() {
        ...
        assert_eq!(cmds[0].name, "winkgo-probe");
