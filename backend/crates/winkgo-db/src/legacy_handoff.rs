...
mod tests {
    ...
    fn migration_002_direct_legacy_reads_are_audited() {
        ...
        let documented_non_contract_reads = [
            ("messages", "hidden", "WinkGo v22 adds it before v23-v26 issue path"),
            (
                "conversations",
                "source",
                "WinkGo v8 baseline before v23-v26 issue path",
            ),
            (
                "conversations",
                "channel_chat_id",
                "WinkGo v14 baseline before v23-v26 issue path",
            ),
            ("mailbox", "files", "WinkGo v25 adds it on the observed v23->v26 path"),
            (
                "remote_agents",
                "allow_insecure",
                "WinkGo v18 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "execution_mode",
                "WinkGo v22 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "agent_config",
