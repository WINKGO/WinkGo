...
--
-- behavior_policy deliberately omits `supports_team`: team capability is
-- derived from the backend and its probed capabilities.
--
...
VALUES
    ('a9f3c21e', '/api/assets/logos/ai-major/antigravity.svg', 'Antigravity',
