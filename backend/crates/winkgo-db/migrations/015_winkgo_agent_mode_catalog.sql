-- Migration 015: persist the built-in winkgo_agent mode catalog.
--
-- winkgo_agent is not an ACP backend, so it does not populate agent_metadata through
...
-- stable winkgo_agent runtime mode catalog here.
