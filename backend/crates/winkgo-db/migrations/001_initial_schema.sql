-- Migration 001: Consolidated initial schema for winkgo-backend
--
-- This is the baseline schema for databases copied from the legacy
-- Electron-managed winkgo.db (v26). It creates all tables, indexes,
...
VALUES
    ...
    -- Internal
    ('632f31d2', '/api/assets/logos/brand/winkgo.svg', 'WinkGo CLI',
     NULL, 'winkgo_agent', 'internal', '{}',
     1, NULL, '[]', '[]',
     '[".winkgo_agent/skills"]',
     '{"supports_team":true}',
     'yolo', 100,
