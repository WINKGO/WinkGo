...
use winkgo_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_winkgo_aliases() {
    ...
    #[test]
    fn teammate_status_serde_winkgo_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_winkgo_format() {
