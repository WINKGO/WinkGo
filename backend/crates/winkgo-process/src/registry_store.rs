...
//!
//! Lives in its own subdir `{data_dir}/runtime/winkgo-process/registry.json`,
...
pub const SUBDIR: &str = "runtime/winkgo-process";
...
/// File-backed registry under `{data_dir}/runtime/winkgo-process/registry.json`.
