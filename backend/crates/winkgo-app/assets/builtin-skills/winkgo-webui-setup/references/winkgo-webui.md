...
```bash
# 允许端口 25808
sudo /usr/libexec/ApplicationFirewall/socketfilterfw --add /Applications/WinkGo.app/Contents/MacOS/WinkGo
sudo /usr/libexec/ApplicationFirewall/socketfilterfw --unblockapp /Applications/WinkGo.app/Contents/MacOS/WinkGo
```
