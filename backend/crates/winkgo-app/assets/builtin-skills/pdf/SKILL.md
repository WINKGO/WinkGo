...
This is the WINK GO compatibility entry for the independently written PDF
Toolkit. It preserves the original `pdf` catalog name without copying the
legacy third-party skill that prohibited redistribution.
...
This original WINK GO skill is distributed under the Apache License 2.0. See
`LICENSE`.
