...
use winkgo_api_types::{BedrockConfig, FetchModelsAnonymousRequest, FetchModelsRequest, FetchModelsResponse};
use winkgo_common::decrypt_string;
...
mod tests {
    ...
    use winkgo_db::{CreateProviderParams, SqliteProviderRepository, init_database_memory};

    const TEST_KEY: [u8; 32] = [0x42; 32];

    async fn setup() -> (ModelFetchService, winkgo_db::Database) {
    ...
    async fn create_provider(db: &winkgo_db::Database, platform: &str, base_url: &str, api_key: &str) -> String {
