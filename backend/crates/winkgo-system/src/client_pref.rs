...
use winkgo_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
use winkgo_db::IClientPreferenceRepository;
...
mod tests {
    ...
    use winkgo_db::{SqliteClientPreferenceRepository, init_database_memory};
