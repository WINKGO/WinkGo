...
mod tests {
    ...
    fn linux_show_item_uses_filemanager1_when_gdbus_available() {
        let path = Path::new("/home/user/Downloads/WinkGo.deb");
        ...
        assert!(args.contains(&"['file:///home/user/Downloads/WinkGo.deb']".to_owned()));
    ...
    fn linux_show_item_percent_encodes_spaces_in_uri() {
        let path = Path::new("/home/user/My Downloads/WinkGo.deb");
        let (program, args) = linux_show_item_command(path, true);
        assert_eq!(program, "gdbus");
        assert!(
            args.contains(&"['file:///home/user/My%20Downloads/WinkGo.deb']".to_owned()),
    ...
    fn build_windows_terminal_command_quotes_paths_with_spaces() {
        let command = build_windows_terminal_command(r#"C:\Users\testuser\My Project"#);
        assert_eq!(command, r#"pushd "C:\Users\testuser\My Project""#);
    }
