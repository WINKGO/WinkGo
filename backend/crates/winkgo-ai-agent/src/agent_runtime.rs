...
use winkgo_api_types::AgentStreamErrorData;
use winkgo_common::{ConversationStatus, TimestampMs, now_ms};
...
impl AgentRuntime {
    ...
    /// Only intended for multi-turn agents (e.g. winkgo_agent) where the same
