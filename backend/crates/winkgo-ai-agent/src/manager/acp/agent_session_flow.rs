...
use winkgo_api_types::SlashCommandItem;
...
impl AcpAgentManager {
    ...
    async fn emit_snapshot_events(&self) {
        use winkgo_api_types::{ModelInfoEntry, ModelInfoPayload};
...
mod tests {
    ...
    use winkgo_api_types::{AgentErrorCode, SlashCommandCompletionBehavior, SlashCommandItem};
