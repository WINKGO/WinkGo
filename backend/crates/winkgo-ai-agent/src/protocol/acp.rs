...
const ACP_CLIENT_NAME: &str = "WinkGo";
...
/// Log a JSON-RPC request from WinkGo to the ACP agent.
...
/// Log a fire-and-forget notification from WinkGo to the agent.
...
/// Log a JSON-RPC response from WinkGo back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "WinkGo");
        ...
        assert_eq!(json["clientInfo"]["name"], "WinkGo");
