...
mod tests {
    ...
    fn test_agent_type_display_names() {
        ...
        assert_eq!(AgentType::WinkGoAgent.display_name(), "WinkGo CLI");
    ...
    fn test_agent_type_id_stability() {
        let id = AgentType::WinkGoAgent.id();
        assert_eq!(id.len(), 8);
        assert!(id.chars().all(|c| c.is_ascii_hexdigit()));
        assert_eq!(AgentType::WinkGoAgent.id(), AgentType::WinkGoAgent.id());
    }
    ...
    fn agent_type_new_conversation_support_policy_is_explicit() {
        ...
        assert!(AgentType::WinkGoAgent.supports_new_conversation());
    ...
    fn agent_type_deprecated_runtime_policy_matches_new_conversation_support() {
        ...
        assert!(!AgentType::WinkGoAgent.is_deprecated_runtime());
    ...
    fn test_mcp_source_serde_roundtrip() {
        let cases = [
            ...
            (McpSource::WinkGoAgent, r#""winkgo_agent""#),
            (McpSource::Nanobot, r#""nanobot""#),
            (McpSource::WinkGoui, r#""winkgo""#),
        ];
    ...
    fn agent_type_full_auto_mode_id_supports_non_acp_agents() {
        ...
        assert_eq!(AgentType::WinkGoAgent.full_auto_mode_id(None), "yolo");
