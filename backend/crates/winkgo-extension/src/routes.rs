...
use winkgo_common::{ApiError, now_ms};
...
impl From<ExtensionError> for ApiError {
    fn from(err: ExtensionError) -> Self {
        match err {
            ...
            ExtensionError::Db(winkgo_db::DbError::NotFound(msg)) => ApiError::NotFound(msg),
            ExtensionError::Db(winkgo_db::DbError::Conflict(msg)) => ApiError::Conflict(msg),
