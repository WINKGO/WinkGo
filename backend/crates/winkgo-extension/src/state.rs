...
const EXTENSION_STATES_FILE_ENV: &str = "WINKGO_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical WinkGo rules.
///
/// Priority:
/// 1. `WINKGO_EXTENSION_STATES_FILE`
