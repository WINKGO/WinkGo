...
///
/// Data is stored in `~/.winkgo/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the winkgo skills market by adding it to external paths.
    ...
    /// Disable the winkgo skills market by removing it from external paths.
