...
mod weixin_tests {
    ...
    use winkgo_channel::manager::{ChannelManager, PluginFactory};
    use winkgo_channel::plugin::ChannelPlugin;
    use winkgo_channel::plugins::weixin::WeixinPlugin;
    use winkgo_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use winkgo_channel::plugins::weixin::weixin_login_stream;
