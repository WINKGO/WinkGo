...
use winkgo_api_types::{BrowseDirectoryResponse, BrowseEntry};
...
/// projects (WINKGO/wink-go#3191) — so strip the prefix before serializing.
...
mod tests {
    ...
    // Regression tests for WINKGO/wink-go#3191: responses must never carry
