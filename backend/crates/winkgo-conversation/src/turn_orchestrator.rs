...
use winkgo_ai_agent::{AgentError, AgentInstance, AgentSendError, AgentSessionKind, IWorkerTaskManager};
use winkgo_common::{AgentType, ConversationStatus, ErrorChain, now_ms};
...
use winkgo_api_types::AgentErrorCode;
...
pub(crate) struct TurnStartInput {
    ...
    /// User message content, already resolved to WINK GO's inlined file form
...
/// `winkgo_common::enums`). What cron's forced full-auto — and a resumed full-access
