...
use winkgo_agent::protocol::events::ToolCategory;
use winkgo_agent::config::{Config, ProviderType, ToolsConfig, SessionConfig};
use winkgo_agent::hooks::HooksConfig;
use winkgo_agent::mcp::config::McpConfig;
use winkgo_agent::provider::{LlmProvider, ProviderError};
use winkgo_agent::tools::Tool;
use winkgo_agent::types::llm::{LlmEvent, LlmRequest};
use winkgo_agent::types::message::{StopReason, TokenUsage};
use winkgo_agent::types::tool::ToolResult;
...
pub fn test_config() -> Config {
    Config {
        ...
        compat: winkgo_agent::provider::compat::ProviderCompat::anthropic_defaults(),
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: winkgo_agent::config::SkillsPermissionConfig::default(),
        },
        ...
        compact: winkgo_agent::config::CompactConfig::default(),
        plan: winkgo_agent::config::PlanConfig::default(),
