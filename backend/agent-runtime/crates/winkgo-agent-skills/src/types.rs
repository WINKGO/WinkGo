...
pub use winkgo_agent_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/winkgo_agent/skills/`
    User,
    /// .winkgo_agent/skills/ (project-level)
    Project,
    /// .winkgo_agent/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .winkgo_agent/commands/ (legacy compatibility)
    Legacy,
}
