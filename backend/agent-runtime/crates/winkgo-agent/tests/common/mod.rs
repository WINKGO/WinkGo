...
use winkgo_agent_providers::{LlmProvider, ProviderError};
use winkgo_agent_tools::Tool;
use winkgo_agent_types::llm::{LlmEvent, LlmRequest};
use winkgo_agent_types::message::{StopReason, TokenUsage};
...
pub fn test_config() -> Config {
    Config {
        ...
        compat: winkgo_agent_config::compat::ProviderCompat::anthropic_defaults(),
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
        ...
        session: SessionConfig {
            enabled: false,
            directory: "/tmp/winkgo_agent-test-sessions".to_string(),
            max_sessions: 5,
        },
