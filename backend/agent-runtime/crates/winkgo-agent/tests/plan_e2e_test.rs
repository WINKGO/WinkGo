...
use serde_json::json;
use winkgo_agent::plan::prompt::plan_mode_instructions;
use winkgo_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use winkgo_agent_protocol::events::ToolCategory;
use winkgo_agent_tools::Tool;
use winkgo_agent_tools::registry::ToolRegistry;
use winkgo_agent_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use winkgo_agent::compact::micro::microcompact;
    use winkgo_agent::plan::state::PlanState;
    use winkgo_agent_config::compact::CompactConfig;
    use winkgo_agent_types::message::{ContentBlock, Message, Role};
