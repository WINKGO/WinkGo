...
use serde_json::json;
use winkgo_agent::confirm::ToolConfirmer;
use winkgo_agent::engine::AgentEngine;
use winkgo_agent::orchestration::execute_tool_calls;
use winkgo_agent::output::OutputSink;
use winkgo_agent::output::null_sink::NullSink;
use winkgo_agent_compact::CompactLevel;
use winkgo_agent_config::compat::ProviderCompat;
use winkgo_agent_config::config::{Config, ProviderType, SessionConfig, ToolsConfig};
use winkgo_agent_config::hooks::HooksConfig;
use winkgo_agent_mcp::config::McpConfig;
use winkgo_agent_providers::create_provider;
...
fn openai_config(api_key: &str) -> Config {
    Config {
        ...
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: winkgo_agent_config::config::SkillsPermissionConfig::default(),
        },
        ...
        compact: winkgo_agent_config::compact::CompactConfig::default(),
        plan: winkgo_agent_config::plan::PlanConfig::default(),
        shell: winkgo_agent_config::shell::ShellConfig::default(),
        file_cache: winkgo_agent_config::file_cache::FileCacheConfig::default(),
        hooks: HooksConfig::default(),
        bedrock: None,
        vertex: None,
        mcp: McpConfig::default(),
        logging: winkgo_agent_config::logging::LoggingConfig::default(),
    }
}
...
impl winkgo_agent_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
    ...
    fn category(&self) -> winkgo_agent_protocol::events::ToolCategory {
        winkgo_agent_protocol::events::ToolCategory::Info
    }
    ...
    async fn execute(&self, _input: serde_json::Value) -> winkgo_agent_types::tool::ToolResult {
        winkgo_agent_types::tool::ToolResult {
