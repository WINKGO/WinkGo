...
mod tests {
    ...
    use winkgo_agent_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
...
mod supplemental_tests {
    ...
    use winkgo_agent_skills::permissions::SkillPermissionChecker;
    use winkgo_agent_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    ...
    async fn tc_13_8_full_variable_substitution_integration() {
        let mut skill = make_skill("my-skill", "Run ${WINKGO_AGENT_SKILL_DIR}/tool.sh $ARGUMENTS[0]");
...
mod supplemental_tests_p6 {
    ...
    use winkgo_agent_skills::permissions::SkillPermissionChecker;
    use winkgo_agent_skills::types::{EffortLevel, ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    use winkgo_agent_tools::Tool;
