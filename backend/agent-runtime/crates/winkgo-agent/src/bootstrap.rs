...
use anyhow::Result;
use tracing::info;
use winkgo_agent_config::config::{Config, McpServerConfig};
use winkgo_agent_config::shell::{ResolvedShell, resolve_shell_config};
use winkgo_agent_mcp::manager::McpManager;
use winkgo_agent_mcp::tool_proxy::register_mcp_tools;
use winkgo_agent_memory::paths::auto_memory_dir;
use winkgo_agent_providers::{LlmProvider, create_provider};
use winkgo_agent_skills::loader::load_all_skills;
use winkgo_agent_skills::permissions::SkillPermissionChecker;
use winkgo_agent_skills::types::SkillMetadata;
use winkgo_agent_tools::edit::EditTool;
use winkgo_agent_tools::exec_command::ExecCommandTool;
use winkgo_agent_tools::file_cache::FileStateCache;
use winkgo_agent_tools::glob::GlobTool;
use winkgo_agent_tools::grep::GrepTool;
use winkgo_agent_tools::read::ReadTool;
use winkgo_agent_tools::registry::ToolRegistry;
use winkgo_agent_tools::tool_search::ToolSearchTool;
use winkgo_agent_tools::view_image::ViewImageTool;
use winkgo_agent_tools::write::WriteTool;
