...
use winkgo_agent_skills::context_modifier::ContextModifier;
use winkgo_agent_skills::executor::{execute_fork, prepare_inline_content};
use winkgo_agent_skills::hooks::{parse_skill_hooks, to_hook_defs};
use winkgo_agent_skills::permissions::{SkillPermission, SkillPermissionChecker};
use winkgo_agent_skills::types::{ExecutionContext, SkillMetadata};
...
pub struct SkillTool {
    ...
    /// Session ID passed to prepare_inline_content for ${WINKGO_AGENT_SESSION_ID} substitution.
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        winkgo_agent_skills::context_modifier::from_skill(skill)
    }
