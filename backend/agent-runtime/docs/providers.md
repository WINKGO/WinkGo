...
```bash
winkgo_agent --profile claude-fast "Quick question"
winkgo_agent --profile claude-deep "Deep security audit"
winkgo_agent --profile dev "Create a GitHub issue"
```
...
```bash
winkgo_agent --profile deepseek-v4-pro --thinking enabled
```
