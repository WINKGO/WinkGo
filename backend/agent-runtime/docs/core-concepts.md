...
This document defines the runtime units used by winkgo_agent. These terms matter
...
If a user asks winkgo_agent to inspect and edit a file, one run might contain:
