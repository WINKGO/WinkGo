...
function getLogFilePath(): string {
  ...
  // Dev mode uses "WinkGo-Dev", production uses "WinkGo"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'WinkGo-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'WinkGo', `${today}.log`);
