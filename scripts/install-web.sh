...
# ============================================================================
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/WINKGO/wink-go/main/scripts/install-web.sh | bash
#   # Or specify version:
...
MIRROR="${MIRROR:-https://github.com/WINKGO/wink-go/releases/download}"
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/WINKGO/wink-go/releases/download
...
print_summary() {
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/WINKGO/wink-go"
    echo -e "  ${BOLD}🐛 Report issues:${NC}  https://github.com/WINKGO/wink-go/issues"
    echo ""
