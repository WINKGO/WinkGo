...
MIRROR="${MIRROR:-https://github.com/xuweihafeichangniu-lab/wink-go/releases/download}"
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/xuweihafeichangniu-lab/wink-go/releases/download
...
print_summary() {
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/xuweihafeichangniu-lab/wink-go"
    echo -e "  ${BOLD}🐛 Report issues:${NC}  https://github.com/xuweihafeichangniu-lab/wink-go/issues"
    echo ""
