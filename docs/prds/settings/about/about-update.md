...
5. 版本号旁有 GitHub 图标，点击在系统浏览器中打开项目仓库 `https://github.com/WINKGO/wink-go`
...
│                                                          │
│  AboutModalContent                                       │
│    ├─ CustomEvent('winkgo-open-update-modal')            │
...
```json
{
  ...
  "updated": true,
  "retryCount": 3,
  "instDir": "C:\\Program Files\\WinkGo",
  "logPath": "%TEMP%\\winkgo-installer-process-check.log",
