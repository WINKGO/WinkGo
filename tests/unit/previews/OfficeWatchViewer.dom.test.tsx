...
describe('OfficeWatchViewer module shape', () => {
  ...
  it('uses the official OfficeCLI website', async () => {
    const mod = await import('@/renderer/pages/conversation/Preview/components/viewers/OfficeWatchViewer');
    expect(mod.OFFICECLI_INSTALL_URL).toBe('https://officecli.ai');
  });
});
 ...
 * officecli has to be installed on the machine running WinkGo, so the error
