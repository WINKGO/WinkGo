...
describe('AssistantEditorSections', () => {
  ...
  it('uses provider-backed models for winkgo_agent even when detected agent metadata exposes model options', () => {
    mockUseModelProviderList.mockReturnValue({
    ...
    renderWithProviders(
      <AssistantEditorSections
        editor={createEditor({
          agent: {
            value: 'agent-winkgo_agent',
            setValue: vi.fn(),
            availableBackends: [
              {
                id: 'agent-winkgo_agent',
                name: 'WinkGoAgent',
                runtimeKey: 'winkgo_agent',
                isExtension: false,
  ...
  it('uses winkgo_agent runtime catalog for default permission options', async () => {
    mockManagedAgentRuntimeCatalog = [
      {
        id: 'agent-winkgo_agent',
        available_modes: {
      ...
      <AssistantEditorSections
        editor={createEditor({
          agent: {
            value: 'agent-winkgo_agent',
            setValue: vi.fn(),
            availableBackends: [backendOption('agent-winkgo_agent', 'winkgo_agent', 'WinkGo CLI')],
          },
        })}
        activeAssistant={null}
      />
