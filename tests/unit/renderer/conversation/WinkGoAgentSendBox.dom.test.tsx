...
import WinkGoAgentSendBox from '@/renderer/pages/conversation/platforms/winkgo_agent/WinkGoAgentSendBox';
import type { WinkGoAgentModelSelection } from '@/renderer/pages/conversation/platforms/winkgo_agent/useWinkGoAgentModelSelection';
...
vi.mock('@/renderer/pages/conversation/platforms/winkgo_agent/useWinkGoAgentMessage', () => ({
  useWinkGoAgentMessage: () => ({
