...
const {
  ...
  agentSelectionMock: {
    ...
    selectedAssistantBackend: 'winkgo_agent',
    ...
    defaultAssistantId: 'bare-winkgo_agent',
...
describe('GuidPage', () => {
  beforeEach(() => {
    ...
    agentSelectionMock.selectedAssistantBackend = 'winkgo_agent';
  ...
  it('applies an winkgo_agent assistant default model after provider models load', async () => {
