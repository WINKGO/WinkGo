...
describe('collectBackendInstallDiagnostics', () => {
  it('records packaged runtime manifest and missing backend binary metadata', () => {
    const files = new Map<string, { mtimeMs: number; size: number; content?: string }>([
      ['C:\\WinkGo\\resources', { mtimeMs: 1000, size: 0 }],
      ['C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64', { mtimeMs: 2000, size: 0 }],
      [
        'C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64\\manifest.json',
        {
          mtimeMs: 3000,
          size: 88,
          content: JSON.stringify({
            ...
            sourceType: 'download',
            files: ['winkgo_core.exe', 'managed-resources/'],
          }),
        },
      ],
    ]);
    ...
    const diagnostics = collectBackendInstallDiagnostics(
      {
        ...
        resourcesPath: 'C:\\WinkGo\\resources',
        checkedBundledPath: 'C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64\\winkgo_core.exe',
      },
      {
        appVersion: '2.1.7',
        arch: 'x64',
        execPath: 'C:\\WinkGo\\WinkGo.exe',
        isPackaged: true,
        platform: 'win32',
    ...
    expect(diagnostics).toEqual({
      ...
      binaryExists: false,
      binaryName: 'winkgo_core.exe',
      binaryPath: 'C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64\\winkgo_core.exe',
      bundledDirPath: 'C:\\WinkGo\\resources\\bundled-winkgo-core',
      execPath: 'C:\\WinkGo\\WinkGo.exe',
      isPackaged: true,
      manifestExists: true,
      manifestFiles: ['winkgo_core.exe', 'managed-resources/'],
      manifestGeneratedAt: '2026-05-29T12:00:00.000Z',
      manifestPath: 'C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64\\manifest.json',
      manifestSize: 88,
      ...
      runtimeDirPath: 'C:\\WinkGo\\resources\\bundled-winkgo-core\\win32-x64',
      runtimeKey: 'win32-x64',
    });
  });
});
