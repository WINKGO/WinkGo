...
`;
    ...
    ).toEqual(['D:\\AgentBin', 'C:\\Users\\testuser\\AppData\\Roaming\\npm']);
  });
...
`;
    ...
    ).toEqual(['D:\\Portable\\opencode\\bin', 'C:\\Users\\testuser\\.local\\bin']);
  });
...
`;
    ...
    ).toEqual(['C:\\Users\\testuser\\.bun\\bin', 'D:\\AgentBin']);
  });
});
...
describe('buildWindowsHydratedPath', () => {
  it('merges missing user and machine registry paths into the current process PATH', () => {
    const hydrated = buildWindowsHydratedPath({
      currentPath: 'C:\\Windows\\System32;C:\\Users\\testuser\\AppData\\Roaming\\npm',
      userRegistryOutput: `
...
`,
    ...
    expect(hydrated).toBe(
      'C:\\Program Files\\Git\\cmd;C:\\Windows\\System32;D:\\AgentBin;C:\\Users\\testuser\\AppData\\Roaming\\npm'
    );
  });
  ...
  it('merges shell profile and fallback paths when they are not in registry PATH', () => {
    const hydrated = buildWindowsHydratedPath({
      ...
      fallbackPathEntries: ['C:\\Users\\testuser\\AppData\\Roaming\\npm', 'D:\\Portable\\opencode\\bin'],
      env: {
        USERPROFILE: 'C:\\Users\\testuser',
      },
    });
    ...
    expect(hydrated).toBe(
      'D:\\Portable\\opencode\\bin;C:\\Users\\testuser\\AppData\\Roaming\\npm;C:\\Windows\\System32'
    );
  });

  windowsOnlyIt('hydrates PATH from real Windows profile files and existing fallback directories', () => {
    const root = mkdtempSync(path.join(tmpdir(), 'winkgo-windows-path-'));
